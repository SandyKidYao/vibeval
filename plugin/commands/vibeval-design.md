...
- **`${CLAUDE_PLUGIN_ROOT}/skills/protocol/references/00-philosophy.md`** — MUST READ FIRST. The two core principles (information asymmetry + global process visibility) govern all design decisions.
...
Key design guidance (from `${CLAUDE_PLUGIN_ROOT}/skills/protocol/references/00-philosophy.md`):
